...
outRstName<-paste0(dir.results,'S1_classif_v7/','S1_classif_',version,'_stratum_',stratum,'.vrt')
inRstName<-paste0(dir.results,'S1_classif_v7/','S1_classif_',version,'_stratum_',stratum,'/*.tif')
...
shp.path<-paste0(dir.data,"S1_GS/v7/land_mask/FinalStratum_astrid/checked_EU_Strata_1and2_Astrid_noHole.shp")
inRstName<-paste0(dir.results,'S1_classif_v7/','S1_classif_',version,'_stratum_',stratum,'-HR.tif')
outRstName<-paste0(dir.results,'S1_classif_v7/','S1_classif_',version,'_stratum_',stratum,'-HR_clipped.tif')
...
# BUILD VRT CLIPPED
outRstName<-paste0(dir.results,'S1_classif_v7/','S1_classif_',version,'_HR_clipped.vrt')
inRstName<-paste0(dir.results,'S1_classif_v7/','S1_classif_',version,'_stratum_','*','-HR_clipped.tif')
...
# create the mosaic
inRstName<-paste0(dir.results,'S1_classif_v7/','S1_classif_',version,'_HR_clipped.vrt')
outRstName<-paste0(dir.results,'S1_classif_v7/','S1_classif_',version,'_HR_clipped.tif')
...
inRstName<-paste0(dir.results,'S1_classif_v7/','S1_classif_',version,'_HR_clipped.tif')
percent=5
outRstName<-paste0(dir.results,'S1_classif_v7/','S1_classif_',version,'_HR_clipped_overview.tif')
